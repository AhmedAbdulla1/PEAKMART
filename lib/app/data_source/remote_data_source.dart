...
import 'package:peakmart/app/models/base_model.dart';
import 'package:peakmart/app/net/create_model_interceptor/create_model.interceptor.dart';
import 'package:peakmart/app/net/create_model_interceptor/default_create_model_inteceptor.dart';
import 'package:peakmart/app/net/http_client.dart';
import 'package:peakmart/app/net/models_factory.dart';
import 'package:peakmart/app/net/response_validators/default_response_validator.dart';
import 'package:peakmart/app/net/response_validators/list_response_validator.dart';
...
class RemoteDataSource {
  ...
  Future<Either<AppErrors, T>> request<T extends BaseModel>({
    required LoginResponse Function(dynamic json) converter,
