...
import 'package:Bid_Mart/features/auth/presentation/views/sign_up/sign_up_view.dart';
...
import 'package:Bid_Mart/features/onboarding/presentation/views/onboarding_view.dart';
import 'package:Bid_Mart/features/products/presentation/views/auction_rules_view.dart';
...
class RouteGenerator {
  static Route<dynamic> getRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case BalanceView.routeName:
        UserInfoEntity userInfo = settings.arguments as UserInfoEntity;
        return MaterialPageRoute(
          builder: (_) => BalanceView(
            userInfo: userInfo,
          ),
        );
