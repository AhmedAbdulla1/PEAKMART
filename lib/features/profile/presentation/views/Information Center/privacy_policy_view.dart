    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(spacing: 20.h, children: const [
            BuildTitleWidget(title: "1. Personal Information We Collect"),
            CustomScrollableText(
              text:
            ...
            BuildTitleWidget(title: "2. Purpose"),
            CustomScrollableText(
                text:
                    "Bidmart will handle your personal data for the following purposes: 1. Manage your registration as Platform user, to identify you and give you access to Services available for registered Platform users. 2. Contacting you through email regarding updates or information related to features, products or services and updates, as long as they are needed or reasonable. 3. Respond to any request or inquiry you make through the customer service channels available at our Platform. 4. We also use your information to generate aggregated non-identifying data. For instance, generate statistics regarding our users, their jobs or areas of expertise, number of impressions or clicks in a specific project or visitor demographics."),
            BuildTitleWidget(title: "3. Use of Your Credit Card"),
            CustomScrollableText(
              text:
                  "You may have to provide a credit card to buy products and services from our website. We use third-party billing services and have no control over these services. We use our commercially reasonable efforts to make sure your credit card number is kept strictly confidential by using only third-party billing services that use industry-standard encryption technology to protect your credit card number from unauthorized use. However, you understand and agree that we are in no way responsible for any misuse of your credit card number. If you are paying with PayPal, we will request the email associated to it. If you request an invoice, we will request your invoicing data, if needed. We don’t save your details, but you will be able to modify or delete your credit cards or PayPal account at any time through the payment method in the purchase form or through the payment method setting in your profile. For security reasons, the use of this feature might require changing of your password. Remember, the safety of the Platform also depends on the correct use and storage of confidential passwords.",
            ),
            BuildTitleWidget(title: "4. Data Retention Period"),
            BuildTextBodyWidget(
              body:
            ...
            BuildTitleWidget(title: "5. Who Obtains Your Data"),
            CustomScrollableText(
              text:
                  "To comply with the purposes indicated in this Privacy Policy, it might be necessary to report or release your personal data to third parties for the following reasons: Business Transfers: regarding any reorganization, restructuring, merge or sale, or any other transfer of assets, including personal, provided that the receiving party accepts to handle your personal information in accordance with our Privacy Policy. Service Providers: to render services in our name or to help us provide our services. For example, we contract service providers to render marketing, advertising, communication, infrastructure and IT services, to customize and improve our service, to process credit card transactions or other methods of payment, provide customer service, collect debts, analyze and improve data (such as data regarding user interaction with our services), and process and manage satisfaction surveys. For efficiency purposes, these partners and providers may be based in the US or other countries or territories outside of the European Economic Area, and might not provide a data protection level comparable to that of your country, or the European Union's. When you accept this Privacy Policy, you are specifically authorizing us to handle and report your personal data to the partners mentioned and/or release your personal data to the service providers responsible for data handling, who are outside of the European Economic Area for the purposes described herein and to provide you complete service. When we release personal information when exchanging data with countries outside the European Economic Area and other areas with data protection laws, we will ensure the information is being transferred in compliance with this Privacy Policy and pursuant to current data protection laws.",
            ),
            BuildTitleWidget(title: "6. Data Protection Rights"),
            CustomScrollableText(
              text:
                  "As the Party Responsible for Data Handling, we are committed to respecting the confidential nature of your personal data and guaranteeing the full exercise of these rights. At all times, you will have the following rights: Right to access. You have the right to confirm whether we are handling your personal data and, if we are, you have the right to obtain a copy of such data and information regarding the handling. Right to amend. You have the right to correct errors, modify incomplete or wrong data and guarantee the authenticity of the information that is being handled. Right to delete. You have the right to request the deletion of your data without undue delay, if it were being handled wrongfully or if the end to which it was handled or collected has ceased to exist. Right to limitation of handling. You have the right to request that the suspension of the handling of your information if it is illegal or the accuracy of the data has been contested. Right to oppose. You have the right to oppose to the handling of your data when it has been used for purposes of direct marketing or when the handling must be terminated due to a personal situation, except when there is legitimate interest or it is necessary for the exercise or defense of claims. Right not to be subjected to personalized decisions. You have the right of not being subjected to a decision based solely on the automatic handling of your data, including profiling, with binding legal effects or which affects you, except when necessary for the execution of an agreement, as permitted by the law or if you have expressly authorized it.",
            ),
            BuildTitleWidget(title: "7. Information About Cookies"),
            BuildTextBodyWidget(
              body:
            ...
            BuildTitleWidget(title: "8. Changes"),
            BuildTextBodyWidget(
              body:
